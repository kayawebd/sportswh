...
<head>
    ...
    <script src="https://kit.fontawesome.com/8426b64bef.js" crossorigin="anonymous"></script>
    ...
    <!-- <script>
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/64894ae7cc26a871b0226752/1h2s4p6tl';
            s1.charset = 'UTF-8';
    ...
    <div class="bodyContainer">
        <div class="topHeader" id="topHeader">
            <header class="siteHeader" id="siteHeader">
                <nav class="menu siteWrapper">
                    <div class="menuBar">
                        <button class="hamburgerMenu" id="hamburgerMenu" aria-label="Show/hide menu">
                        ...
                        <div class="menuAccount">
                            ...
                            ?>
                                ...
                                <div class="dropdownMenu">
                                    <a href="admin/displayProducts.php"><i class="fa-solid fa-user"></i> </a>
                                    <div class="dropdownMenu__Content">
                                        <a href="./admin/displayUsers.php"><i class="fa-solid fa-user"></i>Account</a>
                                        <a href="./admin/displayProducts.php"><i class="fa-solid fa-boxes-stacked"></i>Products</a>
                                        <a href="./admin/displayCategories.php"><i class="fa-solid fa-sitemap"></i>Categories</a>
                                        <a href="./logout.php"><i class="fa-solid fa-right-from-bracket"></i>Logout </a>
                                    </div>
                                </div>
                                <!-- end of dropdown -->
                            <?php } else { ?>
                                <a href="login.php"><i class="fa-solid fa-lock"></i>
                                    Login</a>
                            <?php } ?>
                            <!-- <a href="shopping.php"><i class="fa-solid fa-cart-shopping"></i><span class="show hide">View Cart</span></a> -->
                            <a href="shopping.php" class="menuAccount-shoppingItems"><i class="fa-solid fa-cart-shopping"></i>
                                <?php
                                ...
                                ?>
                                    <?= $numberOfCartItems ?> items</a>
                        <?php else : ?>
                            <?php $numberOfCartItems = null; ?>
                            <a href="shopping.php"><?= $numberOfCartItems ?> items</a>
                        <?php endif; ?>
                    ...
                    <div class="searchContainer">
                        <form id="" action="./searchProducts.php" class="search" method="get" id="searchForm">
                            ...
                            <button type="submit" name="searchButton" value="search" class="searchButton" id="voiceSearchButton" "><i class=" fa-solid fa-magnifying-glass"><span class="sr-only">search</span></i>
                            </button>
                    ...
                    <ul class="menu__items" id="menu">
                        ...
                        ?>
                        <li class="menu__item"><a href="./index.php" class="menu__link 
                            <?php
                            if ($currentPage == "index.php") {
                                echo "activePage";
                            } ?>">Home</a></li>
                        <li class="menu__item"><a href="./products.php" class="menu__link 
                            <?php
                        ...
                        <li class="menu__item "><a href="./contact.php" class="menu__link  
                            <?php
                ...
                <div class="categoryNav">
                    ...
                    if (isset($_GET["id"])) {
                        ...
                        $categorySelected = $db->executeSQLReturnOneValue($stmt);
                    } else {
                        $categorySelected = "";
                    }
                    ?>
                    <ul class="category__items siteWrapper" id="categoryItems">
                        <?php
                        foreach ($categoryRows as $row) :
                            if ($row["categoryName"] === $categorySelected) {
                        ...
                        ?>
                            <li class="category__item <?= $active ?>">
                                <a href="./productsByCategory.php?id=<?= $row["categoryId"] ?>" class="category__link"><?= $row["categoryName"] ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
        ...
        <footer>
            <div class="footerContainer">
                <nav class="footer siteWrapper" aria-label="Website Directory">
                    <div class="footer__navigation footerDirectory">
                        <h2 class="footerHeading">SITE NAVIGATION</h2>
                        <ul class="footer__links">
                            <li class="footer__link"><a href="./index.php">Home</a></li>
                            <li class="footer__link"><a href="./about.php">About Us</a></li>
                            <li class="footer__link"><a href="./contact.php">Contact Us</a></li>
                            <li class="footer__link"><a href="./products.php">View Products</a></li>
                        </ul>
                    </div>
                    <div class="footer__productCategories footerDirectory">
                        <h2 class="footerHeading">PRODUCT CATEGORIES</h2>
                        <ul class="footer__links">
                            <?php
                            $sql = "SELECT categoryId, categoryName FROM category";
                            $stmt = $pdo->prepare($sql);
                            ...
                            ?>
                                <li class="footer__link"><a href="./productsByCategory.php?id=<?= $categoryId ?>"><?= $categoryName ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <div class="footer__contact footerDirectory">
                        <div class="footer__contact--contactUs">
                            ...
                            <ul class="footer__links">
                                ...
                                <li class="footer__link"><a href="./">Delivery & Returns</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="footer__contact footerDirectory">
                        <h2 class="footerHeading">FOLLOW US ON</h2>
                        <div class="footer__contact--socialMedia">
